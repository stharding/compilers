...
David Beazley (http://www.dabeaz.com), Copyright (C) 2012-2019
...
The recommended setup for this project is Python 3.7 or newer with the
...
The project is divided into 8 major parts. Make sure you do the 
...
several thousand lines of Python code.  The ``wabbit`` directory is
...
A reference implementation of the compiler is found in the ``wabbits``

...
class WasmWabbit:
    ...
    def generate_function_code(self, name, argtypes, rettypes, ircode):
        ...
        '''
        typesig = TypeSig(argtypes, rettypes)
        if typesig in self.typesigs:
            typeidx = self.typesigs.index(typesig)
        else:
        ...
        # Add function code to function code section
        funccode = FunctionCode(self.localtypes, self.code)
        self.func_code.append(funccode)
